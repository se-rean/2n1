...
function Partners() {
  ...
  return (
    <div className='snap-mandatory h-[20vh] snap-x flex justify-center flex-row  w-full pl-3 pr-3 pb-14 bg-[#1b212c]'>
      <Swipper items={isDesktop ? 5:1}>
       {
        logo.map(l => (
          <img className='self-center h-auto  snap-center cursor-pointer' src={l.src} alt='' />
        ))
       }
      </Swipper>
    </div>
