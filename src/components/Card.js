...
function Card({ header, title, subtitle }) {
  return ( 
    <div  className="box-border drop-shadow-2xl bg-secondary hover:drop-shadow-xl relative justify-end flex-col lg:bg-primary lg:h-[80%] border-white border-l-2 border-opacity-40">   
