...
function TestimonialCard({ message, name, position, img }) {
  return (
    <div className='snap-center h-full flex testimonial-card flex-col lg:justify-between lg:items-start cursor-pointer hoverActiveBorder'>
      {/* <p className='p-2 mb-[60px] pt-10  z-10 w-full'>{message}</p> */}
      <img alt='' className='object-fill top-0 h-full  opacity-[70%]' src={img}/>
